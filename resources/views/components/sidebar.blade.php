...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="{{ $title == 'Dashboard' ? 'active' : null }}  nav-item"><a class="d-flex align-items-center"
                    href="/admin"><i class="bi bi-ui-checks-grid"></i><span class="menu-title text-truncate"
            ...
            <li class="navigation-header"><span data-i18n="Apps &amp; Pages">Master</span><i
                    data-feather="more-horizontal"></i>
            </li>
            <li class="{{ $title == 'Products' ? 'active' : null }} nav-item"><a class="d-flex align-items-center"
                    href="/admin/products"><i class="bi bi-basket"></i><span class="menu-title text-truncate"
                        data-i18n="Email">Products</span></a>
            </li>
            <li class="{{ $title == 'Category' ? 'active' : null }} nav-item"><a class="d-flex align-items-center"
